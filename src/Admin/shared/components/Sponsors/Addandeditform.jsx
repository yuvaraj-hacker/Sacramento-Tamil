            ...
            <form onSubmit={!formdata?.id ? handlesave : handleupdate}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 mb-3">
                    {/* <div className="mb-2">
                        ...
                        <input type="text" name="Category" value={formdata?.Category} onChange={handlechange} className="w-full px-4 py-2 border rounded-md outline-none" required />
                    </div> */}
                    <div className="mb-2">
                        <div className="mb-2">
                            <label>Category</label>
                        </div>
                        <select name="Category" value={formdata?.Category} onChange={handlechange} className="w-full px-4 py-2 border rounded-md outline-none" required>
