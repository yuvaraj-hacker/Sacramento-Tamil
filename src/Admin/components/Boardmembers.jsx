...
import Tableheadpanel from "../shared/components/Boardmembers/Tableheadpanel";
import Tableview from "../shared/components/Boardmembers/Tableview";
import Addandeditform from "../shared/components/Boardmembers/Addandeditform";
import { deleteBoardmembers, getallBoardmembers, saveBoardmembers, updateBoardmembers } from "../shared/services/apiboardmembers/apiboardmembers";
...
export default function Sponsors() {
  ...
  const handleupdate = async (e) => {
    ...
    try {
      const response = await updateBoardmembers(formDataToSend);
      if (response) {
